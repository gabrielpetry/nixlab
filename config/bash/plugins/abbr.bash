...
# bind space
# Pass the current $_ as an ignored final argument so Bash restores it after the
# bind -x function call instead of replacing it with the handler name.
bind -x '"\C-x ": __abbrev_alias::insert_space "$_"'
bind -x '" ": __abbrev_alias::magic_abbrev_expand_and_insert_space "$_"'

# bind enter
bind -x '"\C-\xFF": __abbrev_alias::magic_abbrev_expand "$_"'
